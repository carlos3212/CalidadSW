<?php
 ...
 if (isset($_POST['pay'])) {
    ...
    $querycmd ="SELECT product.id,
                       ...
                       command.statut,
                       command.userid as 'iduser',

                       users.userid

                       FROM product, command, users
                       WHERE product.id = command.id_produit AND users.userid = command.userid
                       AND command.userid = '{$_SESSION['userid']}' AND command.statut = 'ordered'";
    ...
    $querypay = "UPDATE command SET statut = 'paid' WHERE userid = '{$_SESSION['userid']}' AND statut = 'ordered'";
