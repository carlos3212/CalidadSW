 ...
 <?php
        ...
        //asignar a variable
        $usernameSesion = $_SESSION['lastname'];
        //asegurar que no tenga "", <, > o &
        $username = htmlspecialchars($usernameSesion);       
 
  ?>      
<ul id="dropdown2" class="dropdown-content">
<li><?php echo "<p>Bienvenido $username!</p>";?> </li>
...
<div class="navbar-fixed">
 <nav class="navblack">
   ...
   <ul  class="right hide-on-med-and-down">
     ...
     <li><a href="Información" class="orange-text baskett"><i class="material-icons">information  </i>
