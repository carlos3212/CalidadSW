   ...
   <table>
      ...
      <tbody class="scroll">
        <?php
         include 'db.php';
        //get detailss
        $querydetails = "SELECT * FROM details_command WHERE userid = '$idsess' AND statut ='ready'";
    ...
    <form method="post">
      ...
      <?php
        ...
        if (isset($_POST['done'])) {
          ...
          $queryupdate = "UPDATE details_command SET statut = 'done' WHERE userid = '$idsess' AND statut = 'ready'";
