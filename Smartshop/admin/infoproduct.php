     ...
     <div class="row">
       ...
       <div class="col s12 m4">
         <div class="card">
           ...
           <div class="card-action">
             <a class="blue-text" href="metproduct.php">Ayudas online</a>
           </div>
         </div>
       </div>
       ...
       <div class="col s12 m4">
         <div class="card">
           ...
           <div class="card-action">
             <a class="blue-text" href="cargapage.php">Tiempo de carga </a>
           </div>
         </div>
       </div>
       ...
       <div class="col s12 m4">
         <div class="card">
           ...
           <div class="card-action">
             <a class="blue-text" href="transacciones.php">Transacciones Completadas & Abandonadas </a>
           </div>
         </div>
       </div>
